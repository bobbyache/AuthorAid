...
{
    [TestClass]
    public class UnitTest_SceneRepository
    {
        /// <summary>
        ...
        public void DeleteSceneFromRepository()
        {
            ...
            scenesList[0].CurrentState = Common.PersistableEntityStateEnum.Deleted;
            repository.Scenes.UpdateScenes(scenesList);
        ...
        public void MoreComplicatedRepositoryInsertUpdateDeleteSequence()
        {
            ...
            // delete this scene
            scene1.CurrentState = Common.PersistableEntityStateEnum.Deleted;
            repository.Scenes.UpdateScene(scene1);
            scene1 = null;
        ...
        public void AddedStateIsReturnedInEntity()
        {
            ...
            Assert.AreEqual(retrievedScene.CurrentState, Common.PersistableEntityStateEnum.Added);
        }
        ...
        public void ModifiedStateIsReturnedInEntity()
        {
            ...
            scene.CurrentState = Common.PersistableEntityStateEnum.Modified;

            repository.Scenes.UpdateScene(scene);

            Scene retrievedScene = repository.Scenes.GetScene(sceneCode);
            Assert.AreEqual(retrievedScene.CurrentState, Common.PersistableEntityStateEnum.Modified);
        }
